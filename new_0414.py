...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 13:52:34 2017
...
''' VALIDATION '''
def validation(bldg_clf, cnt_vec, data_val, y_val):
    ...
    GBC_pred_prob = GBC_clf.predict_proba(X_valid)
    GBC_val_logloss = log_loss(y_val, GBC_pred_prob)
    print 'GBC validation log loss: ', GBC_val_logloss
...
GBC_clf = GradientBoostingClassifier(n_estimators=700, random_state=5000).fit(X_train, y_train)
print('Finished training...')


''' VALIDATION '''
validation(bldg_clf, cnt_vec, data_val, y_val)
